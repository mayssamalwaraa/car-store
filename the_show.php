                    ...
                    <div class="description ">
                      ...
                      <p class="price"><?php echo $price;?></p>
                         <div class="details">
                             ...
                             <br>
                             <a href="<?php echo SITEURL;?>order.php?id_c=<?php echo $id2;?>&id_u=<?php echo $id_u;?>" class="btn-sprimary">order</a>
                             <a href="<?php echo SITEURL;?>details-car.php?id_c=<?php echo $id2;?>&id_u=<?php echo $id_u;?>" class="btn-detalis">details</a>
