    ...
    <div class="center">
      ...
      <form  method="post">
        ...
        <div class="sing_up_link">
          ...
          OR <br> <br><a href="<?php echo SITEURL;?>index.php"> Cancel </a>
...
<div class="main-content">
    <div class="wrapper">
        <h1 class="padding-bottom">Add Admin</h1>
...
if(isset($_POST['submit']))
{
    ...
    if($res==TRUE){
        ...
        $_SESSION['add_user']=" <div class='success'>user added successfully you can log in</div>";
        ...
        $_SESSION['add_user']=" Failed to add user ";
