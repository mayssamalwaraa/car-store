...
<html>
    ...
    <body>
        <div class="login">
            ...
            <div class="main_menu">
                <ul>
                     <li><a href="admin-log-in.php"><input type="submit" name="log-in-as-admin" value="log-in-as-admin" class="btn-primary"><br></a></li>
                    <li><a href="log-in.php"><input type="submit" name="log-in-as-customer" value="log-in-as-customer" class="btn-primary"><br></a></li>
            ...
            <h1 class="text-center" >Login as a admin</h1>
            <br><br>
            <?php
        ...
        if (isset($_POST['log-in'])){
            ...
            if($count == 1 ){
                ...
                header("Location:manage-admin.php");
                    ...
                    header("Location:manage_car2.php");
                 }
            }else{
